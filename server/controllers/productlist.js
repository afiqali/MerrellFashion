...
exports.specificlist = function (req, res) {
    ...
    sequelize.query("select p.imageName, p.price, p.Description, p.ItemName, p.status, p.category, p.Itemid, p.created, u.name from productlists p join Users u on p.user_id = u.id where p.Itemid ='" + Itemspecific + "'"
